# Generated by Django 4.2.1 on 2023-10-03 12:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now_add=True, help_text="The object's last update date/time", null=True, verbose_name='updated on')),
                ('counter', models.IntegerField(default=0)),
                ('link', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='link_opened_link', to='link_manager.link')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='link_opened_profile', to='profiles.profile')),
            ],
            options={
                'ordering': ['-updated_on'],
                'get_latest_by': 'updated_on',
